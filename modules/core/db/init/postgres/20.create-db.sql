...
-- begin EVENTS_TASK_STUDENT_LINKalter table EVENTS_TASK_STUDENT_LINK add constraint FK_EVENTS_TASK_STUDENT_LINK_TASK foreign key (TASK_ID) references EVENTS_TASK(ID)^
alter table EVENTS_TASK_STUDENT_LINK add constraint FK_EVENTS_TASK_STUDENT_LINK_STUDENT foreign key (STUDENT_ID) references EVENTS_STUDENT(ID)^
create index IDX_EVENTS_TASK_STUDENT_LINK_TASK on EVENTS_TASK_STUDENT_LINK (TASK_ID)^
create index IDX_EVENTS_TASK_STUDENT_LINK_STUDENT on EVENTS_TASK_STUDENT_LINK (STUDENT_ID)^
